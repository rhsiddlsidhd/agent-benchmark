...
/**
 * 인물 상세 세그먼트 Error Boundary (03_DESIGN §2.7 / 01_ARCHITECTURE §4).
 *
 * getPersonCombinedCredits 등 TMDB fetch 실패(타임아웃/5xx/네트워크)를 이 세그먼트
 * 안에서 잡아 ErrorState 로 노출하고 재시도한다. 루트 error.tsx 와 동일 패턴이지만,
 * 세그먼트 전용으로 두어 인물 상세 페이지만 재요청·재렌더한다.
 *
