...
- 2번째 소비자가 생기기 전에 미리 이 폴더로 옮겨두지 않는다. 이유: `src/utils/CLAUDE.md`와 동일 원칙 — 공유 여부 확정 전 중앙화는 오버엔지니어링

## Gotchas

## 관련 문서

- 파일명 케이스 및 식별자 케이스(SCREAMING_SNAKE_CASE/camelCase): `src/CLAUDE.md`
