...
- **React(Vite) 단순 SPA** — Next.js 아님(SEO/SSR 불필요, 데이터 접근은 `api/**` 서버리스 함수가 전담)
...
- `api/`↔`services/`↔`types/` 배치 이유: `api/CLAUDE.md`
- 컴포넌트 3분류 기준: `src/components/CLAUDE.md`
- zod 런타임 검증 스키마: `src/schemas/CLAUDE.md`
- 공유 순수 함수: `src/utils/CLAUDE.md`
- 공유 상수: `src/constants/CLAUDE.md`
